...
=============================================================================
 Purpose  : Snyder's method (Ct=1.8, Cp=0.6 Deccan calibration), SCS dimensionless UH shape, W50/W75, full hydrographs.
 Source   : sections_14_18_hydrology_swc.py :: SECTION 17
 Depends  : Sections 00–16 must be run first (variables must be in memory).
 Usage    :   %run scripts/section_17_hydrograph.py
           OR exec(open("scripts/section_17_hydrograph.py").read())
=============================================================================
"""

# ─── How to use this file ────────────────────────────────────────────────────
#
# This script is a standalone module for Section 17 of the pipeline.
...
#
# ─────────────────────────────────────────────────────────────────────────────
# SECTION 17 CODE — copied from sections_14_18_hydrology_swc.py :: SECTION 17
# ─────────────────────────────────────────────────────────────────────────────
#
# [PASTE THE SECTION 17 CODE BLOCK HERE]
#
# To extract the code:
#   1. Open sections_14_18_hydrology_swc.py
#   2. Find the header: "SECTION 17 — SYNTHETIC UNIT HYDROGRAPH"
