...
=============================================================================
 Purpose  : R, K, LS, C, P factor rasters; A = R*K*LS*C*P per pixel; SDR (Renfro 1975); annual sediment yield.
 Source   : sections_14_18_hydrology_swc.py :: SECTION 15
 Depends  : Sections 00–14 must be run first (variables must be in memory).
 Usage    :   %run scripts/section_15_rusle.py
           OR exec(open("scripts/section_15_rusle.py").read())
=============================================================================
"""

# ─── How to use this file ────────────────────────────────────────────────────
#
# This script is a standalone module for Section 15 of the pipeline.
...
#
# ─────────────────────────────────────────────────────────────────────────────
# SECTION 15 CODE — copied from sections_14_18_hydrology_swc.py :: SECTION 15
# ─────────────────────────────────────────────────────────────────────────────
#
# [PASTE THE SECTION 15 CODE BLOCK HERE]
#
# To extract the code:
#   1. Open sections_14_18_hydrology_swc.py
#   2. Find the header: "SECTION 15 — RUSLE SOIL EROSION MODEL"
