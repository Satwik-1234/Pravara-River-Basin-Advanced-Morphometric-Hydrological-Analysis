...
"""
=============================================================================
 SECTION 02 — DATA PATHS, LOADING & PREPROCESSING
 Pravara River Basin Morphometric Analysis
=============================================================================
 Purpose  : Define all file paths; load shapefiles + rasters; compute DEM derivatives (slope, hillshade, TWI, SPI).
 Source   : adv_v2_morphometry_pravra3basin.py :: SECTION 2
 Depends  : Sections 00–01 must be run first (variables must be in memory).
 Usage    :   %run scripts/section_02_data_paths.py
           OR exec(open("scripts/section_02_data_paths.py").read())
=============================================================================
"""

# ─── How to use this file ────────────────────────────────────────────────────
#
# This script is a standalone module for Section 02 of the pipeline.
...
#
# ─────────────────────────────────────────────────────────────────────────────
# SECTION 02 CODE — copied from adv_v2_morphometry_pravra3basin.py :: SECTION 2
# ─────────────────────────────────────────────────────────────────────────────
#
# [PASTE THE SECTION 02 CODE BLOCK HERE]
#
# To extract the code:
#   1. Open adv_v2_morphometry_pravra3basin.py
#   2. Find the header: "SECTION 02 — DATA PATHS, LOADING & PREPROCESSING"
