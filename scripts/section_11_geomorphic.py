...
=============================================================================
 Purpose  : Stream Length Gradient Index, Stream Power Index, Topographic Wetness Index rasters and maps.
 Source   : adv_v2_morphometry_pravra3basin.py :: SECTION 11
 Depends  : Sections 00–10 must be run first (variables must be in memory).
 Usage    :   %run scripts/section_11_geomorphic.py
           OR exec(open("scripts/section_11_geomorphic.py").read())
=============================================================================
"""

# ─── How to use this file ────────────────────────────────────────────────────
#
# This script is a standalone module for Section 11 of the pipeline.
...
#
# ─────────────────────────────────────────────────────────────────────────────
# SECTION 11 CODE — copied from adv_v2_morphometry_pravra3basin.py :: SECTION 11
# ─────────────────────────────────────────────────────────────────────────────
#
# [PASTE THE SECTION 11 CODE BLOCK HERE]
#
# To extract the code:
#   1. Open adv_v2_morphometry_pravra3basin.py
#   2. Find the header: "SECTION 11 — GEOMORPHIC INDICES: SL, SPI, TWI"
