...
=============================================================================
 Purpose  : Pearson/Spearman correlation; PCA biplot; clustering; regression; distribution plots.
 Source   : adv_v2_morphometry_pravra3basin.py :: SECTION 5
 Depends  : Sections 00–04 must be run first (variables must be in memory).
 Usage    :   %run scripts/section_05_statistics.py
           OR exec(open("scripts/section_05_statistics.py").read())
=============================================================================
"""

# ─── How to use this file ────────────────────────────────────────────────────
#
# This script is a standalone module for Section 05 of the pipeline.
...
#
# ─────────────────────────────────────────────────────────────────────────────
# SECTION 05 CODE — copied from adv_v2_morphometry_pravra3basin.py :: SECTION 5
# ─────────────────────────────────────────────────────────────────────────────
#
# [PASTE THE SECTION 05 CODE BLOCK HERE]
#
# To extract the code:
#   1. Open adv_v2_morphometry_pravra3basin.py
#   2. Find the header: "SECTION 05 — STATISTICAL ANALYSIS"
