...
"""
=============================================================================
 SECTION 18 — STREAM CHANNEL HYDRAULICS & STABILITY
 Pravara River Basin Morphometric Analysis
=============================================================================
 Purpose  : Leopold-Maddock bankfull geometry, bed shear stress, stream power, W/D ratio stability index.
 Source   : sections_14_18_hydrology_swc.py :: SECTION 18
 Depends  : Sections 00–17 must be run first (variables must be in memory).
 Usage    :   %run scripts/section_18_hydraulics.py
           OR exec(open("scripts/section_18_hydraulics.py").read())
=============================================================================
"""

# ─── How to use this file ────────────────────────────────────────────────────
#
# This script is a standalone module for Section 18 of the pipeline.
...
#
# ─────────────────────────────────────────────────────────────────────────────
# SECTION 18 CODE — copied from sections_14_18_hydrology_swc.py :: SECTION 18
# ─────────────────────────────────────────────────────────────────────────────
#
# [PASTE THE SECTION 18 CODE BLOCK HERE]
#
# To extract the code:
#   1. Open sections_14_18_hydrology_swc.py
#   2. Find the header: "SECTION 18 — STREAM CHANNEL HYDRAULICS & STABILITY"
