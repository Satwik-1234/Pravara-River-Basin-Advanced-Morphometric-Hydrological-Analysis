...
"""
=============================================================================
 SECTION 08 — OUTPUT EXPORT
 Pravara River Basin Morphometric Analysis
=============================================================================
 Purpose  : Export all results to CSV, Excel (.xlsx), and GIS shapefiles; create multi-sheet workbook.
 Source   : adv_v2_morphometry_pravra3basin.py :: SECTION 8
 Depends  : Sections 00–07 must be run first (variables must be in memory).
 Usage    :   %run scripts/section_08_export.py
           OR exec(open("scripts/section_08_export.py").read())
=============================================================================
"""

# ─── How to use this file ────────────────────────────────────────────────────
#
# This script is a standalone module for Section 08 of the pipeline.
...
#
# ─────────────────────────────────────────────────────────────────────────────
# SECTION 08 CODE — copied from adv_v2_morphometry_pravra3basin.py :: SECTION 8
# ─────────────────────────────────────────────────────────────────────────────
#
# [PASTE THE SECTION 08 CODE BLOCK HERE]
#
# To extract the code:
#   1. Open adv_v2_morphometry_pravra3basin.py
#   2. Find the header: "SECTION 08 — OUTPUT EXPORT"
