...
=============================================================================
 Purpose  : Compound flood hazard score from morphometric parameters; flood inundation proxy map.
 Source   : adv_v2_morphometry_pravra3basin.py :: SECTION 13
 Depends  : Sections 00–12 must be run first (variables must be in memory).
 Usage    :   %run scripts/section_13_flood.py
           OR exec(open("scripts/section_13_flood.py").read())
=============================================================================
"""

# ─── How to use this file ────────────────────────────────────────────────────
#
# This script is a standalone module for Section 13 of the pipeline.
...
#
# ─────────────────────────────────────────────────────────────────────────────
# SECTION 13 CODE — copied from adv_v2_morphometry_pravra3basin.py :: SECTION 13
# ─────────────────────────────────────────────────────────────────────────────
#
# [PASTE THE SECTION 13 CODE BLOCK HERE]
#
# To extract the code:
#   1. Open adv_v2_morphometry_pravra3basin.py
#   2. Find the header: "SECTION 13 — FLOOD HAZARD INDICATORS"
