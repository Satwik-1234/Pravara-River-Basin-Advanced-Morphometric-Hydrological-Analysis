...
## [v15.0.0] — 2026-04-15 (Ultimate Publication Suite)

### Added
- **24-Map Ultimate Suite** — High-resolution thematic maps at  institutional standard 600 DPI.
- **Modular Production Scripts** — 19 standalone sections (`section_00.py` to `section_18.py`) for precise isolated execution.
- **Logarithmic Index Scaling** — Implemented `LogNorm` mapping for SPI and STI to resolve high-dynamic range visibility issues.
- **Subbasin Analytics Registry** — Dedicated thematic GeoTIFF exports in `outputs/thematic_rasters/`.
- **Institutional Cartography** — Symmetric 3'/4' DMS grids, Times New Roman typography, and height-matched external legends.

### Fixed
- **SCIENTIFIC INTEGRITY** — Corrected Hypsometric Integral (HI) masking logic; unique, audited values for SB1 (0.222), SB2 (0.267), SB3 (0.249).
- **Cartographic Padding** — Resolved clipping of north arrows and legends in publication exports.
- **Stability** — Sanitized all scripts for Windows console encoding (ASCII logging).

### Changed
- **Repository Optimization** — Purged 85 GB of redundant archives and non-functional scripts to streamline push-to-GitHub readiness.
